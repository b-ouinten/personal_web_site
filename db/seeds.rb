...
# Create projects
agora = create_prject('Agora', 5, [ruby, rails, javascript, html, css, bootstrap, pgsql, git])
le_moulin = create_prject('Le Moulin', 5, [ruby, rails, javascript, react, html, bootstrap, pgsql, git])
ze_kitten_project = create_prject('Ze Kitten Project', 4, [ruby, rails, javascript, bootstrap, pgsql, git])
...
ai_morpion = create_prject('Morpion with AI', 5, [javascript, css, git])
