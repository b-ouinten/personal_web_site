...
french_embassies = create_prject('French embassies', 2, [ruby, rails, bootstrap, pgsql, git])
dwarfurler = create_prject('dwarfURLer', 2, [ruby, rails, bootstrap, pgsql, git])
ai_morpion = create_prject('Morpion with AI', 2, [javascript, css, git])
